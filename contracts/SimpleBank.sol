...
contract SimpleBank {
    ...
    // Hint: it should take 3 arguments: an accountAddress, withdrawAmount and a newB
   ...
   function deposit() public payable returns (uint) {
        require(enrolled[msg.sender], "Customer has not been enrolled.");
     ...
     // @notice Withdraw ether from bank
      ...
      //    sender's balance
      // 3. Emit the appropriate event for this 

        function withdraw(uint withdrawAmount) public returns (uint) {
        require(balances[msg.sender] >= withdrawAmount, "Balance insufficient for transfer.");
